--Begin Tools.lua :)
local SUDO = 270097211 -- put Your ID here! <===
...
1, nil, send_file, '@ACCESS_DENIED_TM', dl_cb, nil)
	end
	if matches[1]:lower() == "sendplug" and matches[2] then
	    local plug = "./plugins/"..matches[2]..".lua"
		tdcli.sendDocument(msg.chat_id_, msg.id_,0, 
1, nil, plug, '@ACCESS_DENIED_TM', dl_cb, nil)
    end
  end
...
if matches[1] == 'Access Denied' then
...
_Sudoer And Admins Access Denied Bot Help :_
